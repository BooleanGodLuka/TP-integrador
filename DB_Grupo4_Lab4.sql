...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (2,34498347,"Stacy","Hinton","1996/07/01","Donec@dignissimlacusAliquam.edu","Apartado núm.: 247, 1450 Ut Ctra.",1,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (4,48056097,"Amir","Mcclain","1999/03/06","a.purus.Duis@urna.co.uk","Apartado núm.: 449, 5633 Libero. Ctra.",14,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (8,47584420,"Andrew","Dejesus","1995/05/18","erat.in@facilisiSed.ca","Apartado núm.: 898, 552 Metus. Avenida",8,true);
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (9,32701913,"Wang","Dejesus","1993/10/10","libero.mauris@Donecegestas.ca","Apartado núm.: 313, 2364 Posuere Avda.",5,true);
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (10,35305191,"Charity","Salazar","1979/06/20","suscipit@aliquamiaculis.com","Apartado núm.: 799, 4606 Non, C/",11,true);
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (11,32321237,"Aphrodite","Acosta","1994/08/30","risus@Duis.org","Apartado núm.: 905, 5931 Maecenas Avda.",9,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (14,40079242,"Tarik","Nicholson","2006/05/05","natoque.penatibus@nequeInornare.ca","Apartado núm.: 475, 4655 Vestibulum C.",14,true);
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (15,45254043,"Bruno","Parker","1993/07/14","luctus.et.ultrices@ridiculusmusAenean.ca","Apartado núm.: 915, 3815 Ultricies Avenida",2,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (17,43122390,"Flynn","Vargas","1982/10/06","malesuada.fames@Donec.org","Apartado núm.: 832, 8368 Ultrices C/",10,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (21,39947446,"Cain","Franco","1974/10/10","elit.pellentesque@et.com","Apartado núm.: 833, 4049 Vitae, Calle",9,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (33,35980110,"Zachary","Hatfield","2001/07/03","Phasellus.dapibus@fermentum.co.uk","Apartado núm.: 958, 3071 Mauris C.",15,true);
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (34,37449808,"Kareem","Hopkins","2010/05/12","consectetuer.ipsum.nunc@urna.org","Apartado núm.: 179, 3147 Quis Avda.",8,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (43,27170439,"Colleen","Saunders","1986/11/21","in.hendrerit@tempus.ca","Apartado núm.: 213, 5576 Turpis. Ctra.",14,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (46,27823025,"Constance","Shelton","1993/06/17","Nulla.tempor@SuspendisseduiFusce.ca","Apartado núm.: 324, 2256 Proin ",13,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (48,40935196,"Oleg","Hardin","2000/04/20","quis.diam@ornare.net","Apartado núm.: 157, 5303 Lorem Ctra.",11,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (50,42833160,"Ira","Cote","2009/12/09","mi.pede.nonummy@gravida.ca","Apartado núm.: 777, 2328 Et Avenida",9,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (56,36031017,"Lester","Vazquez","1979/02/23","semper.dui.lectus@seddolor.edu","Apartado núm.: 922, 4203 Elementum, ",8,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (59,37115676,"Shad","Raymond","1977/02/26","nisi@adipiscingelit.ca","Apartado núm.: 325, 3353 Elit Calle",1,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (61,41927522,"Amethyst","Rice","2002/03/29","nunc.Quisque@mi.net","Apartado núm.: 981, 3430 Augue Avda.",14,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (64,32432370,"Cassandra","Hughes","1983/12/12","felis@Nunclectuspede.net","Apartado núm.: 626, 7858 Dui. Avda.",12,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (67,46214709,"Ginger","Frank","1983/12/18","vehicula.et.rutrum@pharetra.edu","Apartado núm.: 927, 5408 Euismod Calle",8,true);
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (68,46482884,"Natalie","Torres","2006/06/30","sagittis@accumsansedfacilisis.co.uk","Apartado núm.: 964, 7329 Eget C/",6,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (72,35612282,"Vaughan","Casey","1979/08/25","luctus.lobortis.Class@neque.edu","Apartado núm.: 203, 5252 Ante Ctra.",13,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (75,32872467,"Orlando","Wood","2007/07/16","pede.nonummy@mollisnon.co.uk","Apartado núm.: 113, 6110 Cras C/",15,true);
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (76,37775995,"Alfonso","Fuller","1975/10/30","at@orciluctuset.com","Apartado núm.: 100, 8050 Elementum Calle",4,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (78,35453152,"Macy","Mcconnell","1984/12/05","eros.Nam@metusVivamuseuismod.com","Apartado núm.: 988, 979 Vivamus Avenida",12,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (82,34248275,"Fredericka","Savage","1990/12/18","tempor.diam.dictum@duiquis.net","Apartado núm.: 505, 6966 Arcu Calle",4,true);
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (83,34195958,"Honorato","Soto","2006/01/20","ac@temporlorem.ca","Apartado núm.: 154, 3112 Dignissim Avenida",15,true);
...
INSERT INTO `alumnos` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,activo) VALUES (89,44658449,"Quin","Slater","1980/09/11","amet.metus.Aliquam@Aenean.com","Apartado núm.: 214, 7587 Consequat Avenida",11,true);
...
INSERT INTO `docentes` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,`activo`,`telefono`) VALUES (1,33526896,"Daryl","Chen","2000/02/22","risus.Duis.a@loremluctus.net","Apdo.:222-4402 Cum Carretera",11,true,4740110);
INSERT INTO `docentes` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,`activo`,`telefono`) VALUES (2,46256673,"Heidi","Branch","1994/06/06","parturient.montes@ipsum.co.uk","Apartado núm.: 361, 6308 Et Calle",4,true,4740111);
...
INSERT INTO `docentes` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,`activo`,`telefono`) VALUES (12,30566284,"Amelia","Hebert","1978/01/03","et@liberomaurisaliquam.org","Apartado núm.: 545, 2912 Sollicitudin Carretera",7,true,4740121);
...
INSERT INTO `docentes` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,`activo`,`telefono`) VALUES (16,38655917,"Bertha","Booker","1978/08/29","justo.faucibus@nuncnulla.com","Apartado núm.: 893, 4441 Arcu. ",2,true,4740125);
...
INSERT INTO `docentes` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,`activo`,`telefono`) VALUES (19,41151887,"Tyrone","Spencer","2004/06/03","ultricies.ligula.Nullam@semmollis.net","Apartado núm.: 880, 6018 Amet, Av.",2,true,4740127);
...
INSERT INTO `docentes` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,`activo`,`telefono`) VALUES (25,47590391,"Cyrus","Morton","1983/12/26","Cras@tellusfaucibus.net","Apartado núm.: 915, 2469 Sapien. Ctra.",15,true,4740133);
...
INSERT INTO `docentes` (`id`,`dni`,`nombre`,`apellido`,`fechanacimiento`,`email`,`direccion`,`idlocalidad`,`activo`,`telefono`) VALUES (29,31773068,"Brendan","Case","1985/10/03","egestas.rhoncus@vitaemauris.org","Apartado núm.: 764, 5901 Fusce C/",14,true,4740137);
...
INSERT INTO usuarios (idusuario, usuario, clave, activo) VALUES ('2','therrera','123465', true);
