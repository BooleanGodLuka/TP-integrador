...
<table ALIGN="center" id="Modificaciones" width=100%>
  ...
  <tbody>
  <tr>
    <td><input type="text" name="Nombre_Docente" placeholder="Nombre/s..."></td>
    <td><input type="text" name="Apellido_Docente" placeholder="Apellido/s..."></td>
  ...
  <div class="controls">
    ...
    <td style="text-align:center"> <input type="button" value="Actualizar" name="btn_ModificarDocente"style="BORDER: rgb(128,128,128) 3px solid; WIDTH: 150px; FONT-SIZE: 10pt; FONT-FAMILY: Verdana;"></td>
